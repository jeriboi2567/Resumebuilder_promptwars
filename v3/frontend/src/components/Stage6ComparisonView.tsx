...
import { Award, Layers, ChevronRight, Info } from 'lucide-react';
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <h2 className="text-2xl font-extrabold text-white mt-0.5">
              Accumulated Candidate Side-by-Side Comparison
            </h2>
            <p className="text-xs text-slate-300 mt-1">
              Hiring Role: <strong className="text-white">{jobDescription.title}</strong> ({jobDescription.company})
            </p>
          </div>
        </div>

        <div className="bg-slate-900/80 border border-slate-700 p-3 rounded-lg text-right">
          <div className="text-[10px] text-slate-400 font-mono">Accumulated Candidates</div>
          <div className="text-sm font-bold text-emerald-400 font-mono">
            {comparison.rankings.length} Candidate(s) Evaluated
          </div>
        </div>
      </div>
